...
export const UploadIcon = ({ isDragging }: { isDragging: boolean }) => (
  <motion.svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className="size-12 sm:size-16 md:size-20 text-base-content/40"
...
export const BackIcon = () => (
  ...
  >
    <title>Anderes Bild hochladen</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ContinueIcon = () => (
  <svg
    ...
    className="size-5"
  >
    <title>Vorschläge übernehmen</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ResetIcon = () => (
  ...
  >
    <title>Aktion zurücksetzen</title>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const EuroIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M18.5 8a6.5 6.5 0 00-11 5 6.5 6.5 0 0011 3"
    />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 10h4M6 14h4" />
  </svg>
);
