...
export const CallToAction = ({
  ...
  const getButtonText = () => {
    ...
    return user ? "Jetzt starten" : "Jetzt kostenlos starten";
  };

  // Determine subtitle text based on authentication state
  const getSubtitleText = () => {
    if (user) {
      return "Bereit für deinen nächsten Designtraum? Lade ein Foto hoch und lass die KI arbeiten.";
    }
    return "Keine Kreditkarte erforderlich. Starte mit kostenlosen Credits und erlebe die Zukunft des Interior Designs.";
  };
