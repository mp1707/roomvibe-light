  ...
  ({
    ...
    return (
      ...
      >
        ...
        {showInstructionText && (
          <motion.div
            className="absolute bottom-4 left-1/2 z-20 transform -translate-x-1/2 bg-base-100/90 backdrop-blur-sm rounded-full px-4 py-2 text-xs font-medium text-base-content/70 shadow-sm border border-base-100/20 whitespace-nowrap"
